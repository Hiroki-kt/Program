...
for i in material_list:
    for j in size_list:
        ...
        es = ExecuteSVR(data_set_file, use_mic_id=0, use_test_num=2, output_file_name=output_file,
                        config_name=config_file, use_model_file=model_file)
        print("*******************************")
...
es2 = ExecuteSVR(data_set_file, use_mic_id=0, use_test_num=2, output_file_name=output_file, config_name=config_file,
